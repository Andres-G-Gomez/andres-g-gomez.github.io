...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/contour.jpg" title="example image" class="img-fluid d-block mx-auto w-100 w-md-100 w-lg-200" %}
</div>
...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/wt.jpg" title="example image" class="img-fluid d-block mx-auto" style="width: 200%;" %}
</div>
...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/fr.jpg" title="example image" class="img-fluid d-block mx-auto w-100 w-md-100 w-lg-200" %}
</div>
...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/lr.jpg" title="example image" class="img-fluid d-block mx-auto w-100 w-md-100 w-lg-200" %}
</div>
...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/fropt.jpg" title="example image" class="img-fluid d-block mx-auto w-100 w-md-100 w-lg-200" %}
</div>

### Learning Curves
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/lropt.jpg" title="example image" class="img-fluid d-block mx-auto w-100 w-md-100 w-lg-200" %}
</div>
