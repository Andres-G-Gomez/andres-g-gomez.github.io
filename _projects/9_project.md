...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/formulas.jpg" title="example image" class="img-fluid d-block mx-auto w-30 w-md-50 w-lg-75" %}
</div>
...
<div class="container text-center">
        {% include figure.html path="assets/img/9_project/contour.jpg" title="example image" class="img-fluid d-block mx-auto w-30 w-md-50 w-lg-75" %}
</div>
